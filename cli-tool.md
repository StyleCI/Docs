...
```bash
$ composer require styleci/cli:^0.6.3 --dev
```

Global installation:

```bash
$ composer global require styleci/cli:^0.6.3
```
...
```bash
$ curl -SsLo styleci.phar https://github.com/StyleCI/CLI/releases/download/v0.6.3/styleci.phar \
